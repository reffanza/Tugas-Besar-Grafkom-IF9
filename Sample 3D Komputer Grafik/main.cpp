...
void display(void){
	...
	glTranslated(1.0,0.0,0.0);
	glRotatef((GLfloat) day, 0.0,12.0,0.0);
	glColor3f(0.2,1.0,0.6);
	glutWireSphere(0.12,10,8);
	...
	glRotatef((GLfloat) day, 0.0,1.0,0.0);
	glColor3f(0.2,1.0,0.6);
	glutWireSphere(0.142,10,8);
	
	glTranslated(1.0,0.0,0.0);
	glRotatef((GLfloat) day, 0.0,1.0,0.0);
	glColor3f(0.2,1.0,0.6);
	glutWireSphere(0.120,10,8);
	
	glTranslated(1.0,0.0,0.0);
	glRotatef((GLfloat) day, 0.0,1.0,0.0);
	glColor3f(0.2,1.0,0.6);
	glutWireSphere(0.51,10,8);
	
	glTranslated(1.0,0.0,0.0);
	glRotatef((GLfloat) day, 0.0,1.0,0.0);
	glColor3f(0.2,1.0,0.6);
	glutWireSphere(0.49,10,8);
...
void keyboard(unsigned char key, int x, int y){
	switch(key){
	case 'z' : day = (day+10) % 360;
				glutPostRedisplay();
				break;
	case 'Z' : day = (day-10) %360;
				glutPostRedisplay();
				break;
	case 'x' : year = (year + 5) %360;
				glutPostRedisplay();
				break;
	case 'X' : year = (year-5) %360;
				glutPostRedisplay();
